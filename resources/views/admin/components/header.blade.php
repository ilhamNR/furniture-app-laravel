                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 mb-6 mb-lg-0">
                                                            ...
                                                            <div class="mb-0">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo1/dist/authentication/email/verify-email.html"
                                                                        class="menu-link">
                                                                        <span class="menu-title">Verify Email</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo1/dist/authentication/email/invitation.html"
                                                                        class="menu-link">
                                                                        <span class="menu-title">Account
                                                                            Invitation</span>
                                                                    </a>
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo1/dist/authentication/email/password-reset.html"
                                                                        class="menu-link">
                                                                        <span class="menu-title">Reset Password</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                        ...
                        <div class="app-navbar flex-shrink-0">
                            ...
                            <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                ...
                                <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
                                    ...
                                    data-kt-menu-placement="bottom-end">
                                    <img src="{{url('admin/assets/media/avatars/blank.png')}}" alt="user" />
                                </div>
