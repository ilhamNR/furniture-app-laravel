        ...
        <div class="card p-8">
            <div class="d-flex flex-stack mb-5">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                        ...
                        <div class="px-7 py-5">
                            ...
                            <div class="mb-10">
                                ...
                                <div class="d-flex flex-column flex-wrap fw-semibold"
                                    data-kt-docs-table-filter="product_category">
                                    <!--begin::Option-->
                    ...
                    <!--end::Filter-->
                    <!--begin::Add Product-->
                    <a href="{{ route('admin.createProduct') }}" type="button" class="btn btn-primary"
        ...
        var KTDatatablesServerSide = function() {
            ...
            var handleFilterDatatable = () => {
                ...
                filterPayment = document.querySelectorAll(
                    '[data-kt-docs-table-filter="product_category"] [name="product_category"]');
