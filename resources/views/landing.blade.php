...
<body>
    ...
    <div
        class=" mx-8 my-8 text-center rounded-lg bg-white md:p-8 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
        ...
        <div class="flex flex-row max-md:flex-col justify-center">
            <div
                class="mx-8 max-md:my-4 block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
