...
@section('content')
                ...
                <div class="basis-1/4 mx-8 my-6">
                    <div
                        ...
                        <div class="relative overflow-hidden bg-cover bg-no-repeat h-80 w-full flex items-center" data-te-ripple-init
                            ...
                            <img class="rounded-t-lg " src='{{url('storage/product_img/' . $product->thumbnailImage->file_name)}}'
                                alt="" />
                            <a href="#!">
                                <div
    ...
    <div data-te-modal-init
        ...
        <div data-te-modal-dialog-ref
            class="pointer-events-none relative flex items-center h-full w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-auto  min-[576px]:max-w-[500px] min-[992px]:max-w-[800px] min-[1200px]:max-w-[1140px]">
            <div
                ...
                <div class="relative p-4">
                    <div class="flex flex-row max-lg:flex-col">
                        ...
                        <div class="basis-1/2 ml-3">
                            ...
                            <h5 class="my-2 text-xs font-medium leading-tight text-neutral-800">
                                Details
                            </h5>
